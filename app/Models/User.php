...
class User extends Authenticatable
{
    ...
    /**
     * Get orders that were referred by this user as an affiliate.
     */
    ...
    /**
     * Check if the user has an approved affiliate profile.
     */
    public function hasApprovedAffiliate(): bool
    {
        return $this->affiliate && $this->affiliate->status === 'approved';
    }
}